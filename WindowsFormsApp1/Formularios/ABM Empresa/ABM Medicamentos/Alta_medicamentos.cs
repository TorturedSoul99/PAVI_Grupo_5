...
namespace WindowsFormsApp1.Formularios.ABM_Empresa.ABM_Medicamentos
{
    public partial class Alta_medicamentos : Form
    {
        ...
        {
            medicamento.AltaMedicamento(txt_nombre_medicamento.Text,Convert.ToInt32(cmb_laboratorio_med.SelectedValue.ToString()), dtp_fechaCompra.Value.ToString(),Convert.ToInt32( cmb_sucursal_med.SelectedValue.ToString()));
